...
public class SourceValidator2 
    ...
    /** Default constructor. */
    public SourceValidator2() {
    	this.maxerrors = DEFAULT_MAXERRORS;
    } // <init>()
    
    /** Default constructor. */
    public SourceValidator2(long maxerrors) {
    ...
    public static void main (String [] argv) {
        ...
        try {
            ...
            SourceValidator2 sourceValidator = new SourceValidator2(maxerrors);
